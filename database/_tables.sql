...
CREATE TABLE series(
    ...
    lastModifier INT(11) NOT NULL,
    PRIMARY KEY(id),
    CONSTRAINT fk_series_creater_users_id FOREIGN KEY (creater)
    REFERENCES users(id),
    CONSTRAINT fk_series_lastModifier_users_id FOREIGN KEY (lastModifier)
    REFERENCES users(id)
);
...
CREATE TABLE seasons(
    ...
    PRIMARY KEY(id),
    CONSTRAINT fk_seasons_series_series_id FOREIGN KEY (series)
...
CREATE TABLE episodes(
    ...
    PRIMARY KEY(id),
    CONSTRAINT fk_episodes_season_seasons_id FOREIGN KEY (season)
